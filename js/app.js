(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            const thumbsSwiper = new core(".image-mini-slider", {
                modules: [ freeMode ],
                slidesPerView: 3.5,
                spaceBetween: 3,
                watchSlidesProgress: true,
            ...
            new core(".image-slider", {
                ...
                navigation: {
                    nextEl: ".image-swiper-button-left",
                    prevEl: ".image-swiper-button-right"
                },
                thumbs: {
                    swiper: thumbsSwiper
                }
            });
            new core(".pets-swiper", {
                ...
                navigation: {
                    prevEl: ".pets-swiper-button-left",
                    nextEl: ".pets-swiper-button-right"
                },
                breakpoints: {
                    420: {
                        slidesPerView: 2,
            ...
            new core(".parallax-slider", {
                modules: [ Navigation, Parallax ],
                parallax: true,
                speed: 2e3,
                loop: true,
                navigation: {
                    nextEl: ".parallax-swiper-button-right",
                    prevEl: ".parallax-swiper-button-left"
                }
            });
        }
    }
